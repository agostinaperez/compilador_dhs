...
public class compiladoresLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LETRA", "DIGITO", "NUMERO", "INT", "FLOAT", "CHAR", "STRING", "VOID", 
			"IF", "ELSE", "FOR", "WHILE", "RETURN", "WS", "PA", "PC", "LLA", "LLC", 
			"PYC", "COMA", "MAS", "MENOS", "POR", "DIV", "IGUAL", "MAYOR", "MENOR", 
			"DIF", "IGUALIGUAL", "Y", "O", "NO", "ID", "OTRO"
		};
	}
